...
from a simple text file that you provide.
(We also supply some example text below, but try the program
...
don't worry: just put the data directly into your program;
